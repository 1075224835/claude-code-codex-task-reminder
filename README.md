...
全屏提醒是一个面向 Windows 的任务提醒工具，非常适合多主机多屏幕用户，附属电脑运行AI任务完成时你会在主电脑上得到消息提醒。由 **接收端** 和 **发送端** 组成。发送端监听 Claude Code / Codex 等任务状态，接收端在本机弹出强提示的全屏提醒，也可以选择通过 Server 酱推送到微信。

> 适合长时间跑任务、等待代码代理完成、需要人工确认时不想错过提醒的场景。

<p align="center">
  <img src="pig.png" alt="全屏提醒展示图" width="900">
</p>
...
| 🔕 智能体降噪 | 自动忽略 Codex 子智能体的完成事件，只在主任务完成时提醒。 |
